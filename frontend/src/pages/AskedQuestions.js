        ...
        <Row>
          <Col md={12}>
            ...
            <div className='box'>
              ...
              <p>
                You can purchase items directly from our website. Simply browse
                our collection, add desired items to your cart, and proceed to
                checkout. We accept various payment methods for your
                convenience.
              </p>
              <hr />
              {/* FAQ Item 3 */}
              ...
              <p>
                Yes, we offer international shipping. Please note that shipping
                costs and delivery times may vary depending on the destination.
                You can view shipping details during the checkout process.
              </p>
              <hr />
              {/* FAQ Item 4 */}
              ...
              <p>
                ...
                date. Please review our return policy for detailed instructions
                on the process.
              </p>
              <hr />
              {/* FAQ Item 5 */}
              ...
              <p>
                ...
                excellent presents for friends and family who appreciate quality
              ...
              <p>
                ...
                methods. Your payment information is encrypted and secure during
                the transaction.
              </p>
            </div>
          </Col>
