    ...
    <>
      <div className='content'>
        ...
        <Row>
          <Col md={12}>
            ...
            <div className='box'>
              ...
              <p>
                At our studio, we strive to blend creativity with practicality,
                offering a range of designs that not only captivate the eye but
        ...
        <Row>
          <Col md={6}>
            <div className='box'>
              ...
              <p>
                Explore our collection of modern designs, where simplicity meets
                sophistication. From sleek furniture to minimalist decor, our
                creations embody a timeless sense of elegance.
              </p>
            </div>
          </Col>
          <Col md={6}>
          ...
          <Col md={6}>
            <div className='box'>
              ...
              <p>
                ...
                ideas into reality, creating bespoke designs tailored to your
                preferences.
              </p>
            </div>
          </Col>
          <Col md={6}>
            <div className='box'>
              ...
              <p>
                Our favorite projects showcase a curated selection of designs
                that hold significant creative value and have made a lasting
                impact. Visit us to explore these remarkable creations.
              </p>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          <Col md={6}>
            <Card>
              <Image src='/images/antiques.png' alt='antiques' />
            </Card>
          </Col>
          <Col md={6}>
            <div className='box'>
              <h1>Our Vision</h1>
              <p>
                At our design studio, our vision is to redefine aesthetics and
                functionality through innovative designs. We aim to inspire and
                elevate spaces by creating designs that resonate with both
